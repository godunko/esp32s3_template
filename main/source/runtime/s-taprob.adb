...
--        Init_Priority : Integer := Ceiling_Priority;
   ...
   begin
      raise Program_Error with "`Initialize_Protection` is not implemented";
...
--        Caller_Priority : constant Any_Priority := Get_Priority (Self_Id);
   ...
   begin
      raise Program_Error with "`Lock` is not implemented";
...
--        Caller_Priority : constant Any_Priority := Object.Caller_Priority;
   ...
   begin
      raise Program_Error with "`Unlock` is not implemented";
